      ...
      <div className="max-w-7xl mx-auto ">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8 ">
          ...
          >
            ...
            >
              <h1 className="text-3xl sm:text-5xl   md:text-[54px]  font-pilogue font-extrabold leading-tight">
            ...
            <motion.p
              ...
              className="text-base sm:text-lg lg:text-xl text-gray-600 font-pilogue font-medium leading-relaxed max-w-xl mx-auto lg:mx-0"
            >
            ...
            >
              <div className="flex flex-col sm:flex-row gap-4 w-full max-w-sm sm:max-w-md">
                <button  onClick={scrollToServices} className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-full font-semibold flex items-center gap-2 transition-all shadow-lg hover:shadow-xl">
                Our Services<ArrowRight className="w-5 h-5" />
                </button>
                <Link to="/book-call" className="bg-black hover:bg-gray-800 text-white px-8 py-4 rounded-full font-semibold transition-all flex items-center gap-2">
          ...
          <div className="w-full lg:w-1/2 flex justify-center items-center pt-8 lg:pt-0 order-1 lg:order-2">
            <div className="relative w-full flex justify-center items-center aspect-square max-w-md sm:max-w-lg mx-auto">
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 0.4 }}
